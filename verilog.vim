...
syn keyword verilogTodo contained TODO FIXME NOTE MODIFY

"david add for verilog
syn match verilogModify  " .*_by_david_\d\{8}_.*"
...
"modeify by daivd
syn match   verilogComment "//.*" contains=verilogTodo,verilogModify,@Spell
...
"add by zzy
hi def link verilogModify          Todo
